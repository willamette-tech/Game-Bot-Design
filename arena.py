...
and their moves are collected before any movement is resolved.  The types a bot author
reads and writes live in ``bot_api.py``; only the rules live here.
"""
...
from bot_api import DIRECTIONS, Direction, Grid, Opponent, State
